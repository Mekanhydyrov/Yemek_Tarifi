<%@ Page Title="" Language="C#" MasterPageFile="~/Kullanici.Master" AutoEventWireup="true" CodeBehind="AnaSayfa.aspx.cs" Inherits="Yemek_Tarifi.AnaSayfa" %>
            ...
            <table class="auto-style4">
                ...
                <tr>
                    <td class="auto-style9">
                        <asp:Image ID="Image1" runat="server" Height="200px" ImageUrl='<%# Eval("YemekResim") %>' Width="400px" />
                    </td>
                </tr>
                <tr>
                    <td></td>
